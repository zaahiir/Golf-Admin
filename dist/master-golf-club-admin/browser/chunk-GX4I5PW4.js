import{a as Q}from"./chunk-DVM5LER3.js";import{Ia as w,Ja as d,K as E,Ka as P,La as R,Q as h,Qa as G,R as I,Ra as V,Ta as O,U as D,Wa as j,ab as z,ba as k,bb as A,ca as N,cb as $,d as _,db as H,fa as L,g as T,ha as q,ia as M,la as B,ma as U,t as S}from"./chunk-RS62WWGD.js";import{Ib as t,Jb as n,Kb as f,Sb as g,Tb as x,bb as i,cb as F,cc as e,ec as p,ha as y,lc as C,sb as s,yb as r}from"./chunk-NP3QOLCN.js";import{f as K,k as b}from"./chunk-AAPNLDO3.js";var v=K(Q());function W(o,m){if(o&1&&(t(0,"c-form-feedback",22),e(1),n()),o&2){let l=x();r("valid",!1),i(),p(`
    ...
    `),t(2,"c-col",0),e(3,`
      ...
      `),n(),e(97,`
    `),n(),e(98,`
  `),n()),a&2&&(i(14),r("formGroup",c.tournamentForm),i(2),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("tournamentName")),i(3),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("tournamentDate")),i(3),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("tournamentTime")),i(3),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("tournamentLocation")),i(3),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("tournamentDescription")),i(3),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("entryFee")),i(3),r("cFormFloating",!0),i(7),r("ngIf",c.isFieldInvalid("maxParticipants")),i(5),r("disabled",c.loading),i(),p(`
                `,c.loading?"Saving...":"Save Tournament",`
              `),i(2),r("disabled",c.loading))},dependencies:[_,T,U,B,h,M,D,I,H,G,w,V,P,R,z,O,j,$,k,L,q,N,E]});let o=m;return o})();export{xe as UpdateTournamentComponent};
